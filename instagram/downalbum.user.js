    ...
    if (t && src) {
        ...
        if (!isProfile && (albumBtn || t.getAttribute('poster'))) {
            ...
            if (loadedPosts[url] !== undefined) {
                ...
                (albumBtn ? m.edge_sidecar_to_children.edges : [{
                    node: m
                }]).forEach((e, i) => {
                    const {
                        dash_info,
    ...
    try {
        ...
        items.forEach((e, i) => {
            ...
            if (e.video_resources) {
                ...
                const {
                    src
                } = e.video_resources[e.video_resources.length - 1];
...
function getText(s, html, parent) {
    ...
    var t = 'textContent';
    if (q && q.querySelectorAll('br').length) {
        t = 'innerHTML';
    }
    if (q && html && q.querySelectorAll('a').length) {
        t = 'innerHTML';
    }
    return q ? q[t] : "";
}
...
function getWeiboAlbum() {
    if (!GM_xmlhttpRequest) {
        return alert("This script required Greasemonkey/Tampermonkey!");
    }
    GM_xmlhttpRequest({
        method: "GET",
